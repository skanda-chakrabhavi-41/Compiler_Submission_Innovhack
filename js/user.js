    ...
    reader.onloadend = async () => {
        ...
        try {
            ...
            analyzeGrievance(title, description, category, address).then(async (aiAnalysis) => {
                ...
                // Check for High Priority and Similar Grievances to Post/Update Social Feed
                if (priority === "High") {
                    ...
                    if (pincode) {
                        // Check for existing social post for this category and pincode
                        ...
                        if (!socialSnap.empty) {
                            ...
                            const postContent = await generateSocialPost({ title, description, municipality, address, category });
