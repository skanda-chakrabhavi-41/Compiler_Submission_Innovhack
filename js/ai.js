...
export async function analyzeGrievance(title, description, category, address) {
    try {
        ...
        return { priority: "Medium", summary: description.substring(0, 50) + "...", tags: [category] };
    }
}
...
export async function generateSocialPost(grievance) {
    try {
        ...
        Focus on the specific details of the grievance and the impact on the community. Do not just summarize.
        Use emojis.
